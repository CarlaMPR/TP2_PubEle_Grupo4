...
<p><b> O presente trabalho prático consistiu na elaboração de uma aplicação FLASK que permite criar, ler, editar/atualizar e eliminar relatórios (<b>funções CRUD</b>). Foi usada a SHELVE <b>reports.db</b> e, separou-se o backend do frontend da aplicação, <b>ficheiro app.py</b>.</p>
